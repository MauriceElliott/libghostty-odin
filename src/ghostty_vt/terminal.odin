...
terminal_resize :: proc(t: Terminal, cols, rows: u16, cell_width_px, cell_height_px: u32) -> Error {
	return result_to_error(vt_c.terminal_resize(t.handle, cols, rows, cell_width_px, cell_height_px))
}

terminal_vt_write :: proc(t: Terminal, data: []u8) {
